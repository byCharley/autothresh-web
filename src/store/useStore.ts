...
export interface PresetData {
  ...
  // DTG/DTF fields (new pipeline)
  printSettings?: Partial<V2Settings>;
}
...
const DEFAULT_LAYERS: LayerConfig[] = [
  {
    ...
    thresholdMin: 0, thresholdMax: 31,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
    pattern: 'noise', patternScale: 1, patternAngle: 45, patternDensity: 85,
  },
  {
    id: 'shadows-2', name: 'Shadows 2', color: '#2D1200', visible: true,
    thresholdMin: 32, thresholdMax: 63,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
    pattern: 'noise', patternScale: 1, patternAngle: 45, patternDensity: 78,
  },
  {
    id: 'midtones', name: 'Midtones', color: '#6B1A00', visible: true,
    thresholdMin: 64, thresholdMax: 95,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
    pattern: 'noise', patternScale: 1, patternAngle: 45, patternDensity: 72,
  },
  {
    id: 'midtones-2', name: 'Midtones 2', color: '#A33010', visible: true,
    thresholdMin: 96, thresholdMax: 127,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
    pattern: 'noise', patternScale: 1, patternAngle: 45, patternDensity: 65,
  },
  {
    id: 'highlights', name: 'Highlights', color: '#D45A1A', visible: true,
    thresholdMin: 128, thresholdMax: 159,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
    pattern: 'noise', patternScale: 1, patternAngle: 45, patternDensity: 58,
  },
  {
    id: 'highlights-2', name: 'Highlights 2', color: '#FF8C42', visible: true,
    thresholdMin: 160, thresholdMax: 191,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
    pattern: 'halftone-round', patternScale: 4, patternAngle: 45, patternDensity: 55,
  },
  {
    id: 'specular', name: 'Specular', color: '#FFD4A0', visible: true,
    thresholdMin: 192, thresholdMax: 223,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
    pattern: 'halftone-round', patternScale: 4, patternAngle: 45, patternDensity: 45,
  },
  {
    id: 'specular-2', name: 'Specular 2', color: '#F5F0E8', visible: true,
    thresholdMin: 224, thresholdMax: 255,
    exposure: 0, blur: 0,
    useGlobalPattern: true,
...
interface AppState {
  ...
  globalPattern: PatternConfig;
  thresholdPreBlur: number;  // Gaussian blur applied to source image before thresholding (0 = off)
  ...
  setThresholdPreBlur: (v: number) => void;
...
export const useStore = create<AppState>((set, get) => ({
  ...
  addLayer: () => set((s) => {
    ...
    const newLayer: LayerConfig = {
      ...
      visible: true,
      thresholdMin: 0, thresholdMax: 255,
      exposure: 0, blur: 0,
      useGlobalPattern: true,
  ...
  loadPreset: (data) => set((s) => {
    ...
    const dtg = data.mode === 'dtg' ? {
      printSettings: { ...s.printSettings, ...(data.printSettings ?? {}) },
    } : {};
  ...
  capturePreset: (): PresetData => {
    ...
    if (s.separationMode === 'dtg') {
      base.printSettings = { ...s.printSettings };
    }
    return base;
  },
}));
