...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const [sealResult, ldtLifetime, testerRecord, securityResult, userPrefs] = await Promise.all([
  ...
  console.log('Verify result:', { email, hasSub, isCreator, isTester, testerRecord, ldtLifetime, finalHasSub, finalStatus, planTitle: finalPlan, nextBillingDate: finalExpiry });
